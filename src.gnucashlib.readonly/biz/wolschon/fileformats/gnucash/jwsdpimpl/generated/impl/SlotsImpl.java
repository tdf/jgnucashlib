    ...
    implements biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.Slots, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.runtime.UnmarshallableObject, biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.runtime.XMLSerializable, biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.Slots.class);
    }
    ...
    public biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.runtime.UnmarshallingEventHandler createUnmarshaller(biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.runtime.UnmarshallingContext context) {
        return new biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.SlotsImpl.Unmarshaller(context);
    }

    public void serializeBody(biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "slots");
...
+"URIq\u0000~\u0000 xq\u0000~\u0000\u001bt\u00009biz.wolschon.fileformats.gnucash.jwsdpimpl."
+"generated.Slott\u0000+http://java.sun.com/jaxb/xjc/dummy-elements"
+"sq\u0000~\u0000\u0000q\u0000~\u0000\u0010p\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\nppsq\u0000~\u0000\fq\u0000~\u0000\u0010psq\u0000~\u0000\u0015q\u0000~\u0000"
+"\u0010pq\u0000~\u0000\u0018q\u0000~\u0000\u001cq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000=biz.wolschon.fileformats.gnucash.j"
+"wsdpimpl.generated.SlotTypeq\u0000~\u0000#sq\u0000~\u0000\nppsq\u0000~\u0000\u0015q\u0000~\u0000\u0010psr\u0000\u001bcom."
...
+"\u0000\u001esq\u0000~\u0000\u001ft\u0000\u0004slott\u0000\u0000q\u0000~\u0000\u001esq\u0000~\u0000\nppsq\u0000~\u0000\u0015q\u0000~\u0000\u0010pq\u0000~\u00001q\u0000~\u0000Aq\u0000~\u0000\u001esq"
+"\u0000~\u0000\u001ft\u0000\u0005slotsq\u0000~\u0000Fsr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000"
...
+"ammar/ExpressionPool;xp\u0000\u0000\u0000\u000b\u0001pq\u0000~\u0000\u0011q\u0000~\u0000,q\u0000~\u0000Gq\u0000~\u0000%q\u0000~\u0000\u000eq\u0000~\u0000\tq"
+"\u0000~\u0000\u000bq\u0000~\u0000\u0014q\u0000~\u0000(q\u0000~\u0000\u0013q\u0000~\u0000\'x"));
        }
        ...
        extends biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.SlotsImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("slot" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.SlotsTypeImpl)biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.SlotsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        if (("slot" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.SlotsTypeImpl)biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.SlotsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
            ...
            while (true) {
                switch (state) {
                    ...
                    case  2 :
                        ...
                        break;
                    case  1 :
                        spawnHandlerFromLeaveElement((((biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.SlotsTypeImpl)biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.SlotsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.SlotsTypeImpl)biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.SlotsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.SlotsTypeImpl)biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.SlotsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.SlotsTypeImpl)biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.SlotsImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }

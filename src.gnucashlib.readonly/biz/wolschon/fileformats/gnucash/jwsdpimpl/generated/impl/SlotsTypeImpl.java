...
+"ssionPool;xp\u0000\u0000\u0000\t\u0001pq\u0000~\u0000\u000bq\u0000~\u0000*q\u0000~\u0000#q\u0000~\u0000\bq\u0000~\u0000\u0005q\u0000~\u0000\u0011q\u0000~\u0000&q\u0000~\u0000\u0010q\u0000"
+"~\u0000%x"));
        }
                ...
                switch (state) {
                    case  1 :
                        if (("slot_key" == ___local)&&("" == ___uri)) {
                            _getSlot().add(((biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.SlotTypeImpl) spawnChildFromEnterElement((biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.SlotTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  0 :
                        if (("slot" == ___local)&&("" == ___uri)) {
                            _getSlot().add(((biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.SlotImpl) spawnChildFromEnterElement((biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.SlotImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("slot" == ___local)&&("" == ___uri)) {

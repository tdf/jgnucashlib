                ...
                switch (state) {
                    ...
                    case  3 :
                        if (("slot_value" == ___local)&&("" == ___uri)) {
                            _SlotValue = ((biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.SlotValueImpl) spawnChildFromEnterElement((biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.SlotValueImpl.class), 6, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("slot_value" == ___local)&&("" == ___uri)) {
                            context.pushAttributes(__atts, true);
                ...
                switch (state) {
                    ...
                    case  4 :
                        if (("type" == ___local)&&("" == ___uri)) {
                            _SlotValue = ((biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.SlotValueTypeImpl) spawnChildFromEnterAttribute((biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.SlotValueTypeImpl.class), 5, ___uri, ___local, ___qname));
                            return ;
                        }
                        break;
                }

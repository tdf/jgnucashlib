...
public interface GnucashInvoice extends Comparable<GnucashInvoice> {
     ...
     */
    FixedPointNumber getAmmountUnPayed() throws JAXBException;
    /**
     * Formating uses the default-locale's currency-format.
     * @return what the customer must still pay (incl. taxes)
     * @throws JAXBException if we have issues with the XML-backend
     */
    String getAmmountUnPayedFormatet() throws JAXBException;
    /**
     * @return what the customer has already pay (incl. taxes)
     * @throws JAXBException if we have issues with the XML-backend
     */
    FixedPointNumber getAmmountPayedWithTaxes() throws JAXBException;
    /**

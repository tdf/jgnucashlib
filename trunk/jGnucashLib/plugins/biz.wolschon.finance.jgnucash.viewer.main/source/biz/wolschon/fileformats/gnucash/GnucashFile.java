...
public interface GnucashFile extends GnucashObject {
     ...
     */
    Collection<GnucashInvoice> getPayedInvoices() throws JAXBException;
     ...
     * @throws JAXBException if we have issues with the XML-backend
     */
    Collection<GnucashInvoice> getUnpayedInvoices() throws JAXBException;
     ...
     * @throws JAXBException if we have issues with the XML-backend
     */
    Collection<GnucashInvoice> getUnpayedInvoicesForCustomer(GnucashCustomer customer) throws JAXBException;

...
+"ammar/ExpressionPool;xp\u0000\u0000\u0000\u0013\u0001pq\u0000~\u0000\u0013q\u0000~\u0000\'q\u0000~\u0000Kq\u0000~\u0000Sq\u0000~\u0000\u0007q\u0000~\u0000Fq"
+"\u0000~\u0000+q\u0000~\u0000Wq\u0000~\u0000$q\u0000~\u0000Pq\u0000~\u0000\u0005q\u0000~\u0000\rq\u0000~\u0000Hq\u0000~\u0000\u0012q\u0000~\u0000&q\u0000~\u0000Jq\u0000~\u0000Rq\u0000~\u0000\nq"
+"\u0000~\u0000Gx"));
        }
                ...
                switch (state) {
                    case  6 :
                        if (("gnc_transaction" == ___local)&&("" == ___uri)) {
                            _getGncTransaction().add(((biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.GncTransactionImpl) spawnChildFromEnterElement((biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.GncTransactionImpl.class), 6, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("gnc_transaction" == ___local)&&("" == ___uri)) {
                    ...
                    case  3 :
                        if (("gnc_account" == ___local)&&("" == ___uri)) {
                            _getGncAccount().add(((biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.GncAccountImpl) spawnChildFromEnterElement((biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.GncAccountImpl.class), 3, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("gnc_account" == ___local)&&("" == ___uri)) {
                            context.pushAttributes(__atts, false);
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("version" == ___local)&&("" == ___uri)) {
                            _getGncAccount().add(((biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.GncAccountTypeImpl) spawnChildFromEnterAttribute((biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.GncAccountTypeImpl.class), 2, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  4 :
                        if (("version" == ___local)&&("" == ___uri)) {
                            _getGncTransaction().add(((biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.GncTransactionTypeImpl) spawnChildFromEnterAttribute((biz.wolschon.fileformats.gnucash.jwsdpimpl.generated.impl.GncTransactionTypeImpl.class), 5, ___uri, ___local, ___qname)));
                            return ;
                        }
                        break;
                    case  0 :

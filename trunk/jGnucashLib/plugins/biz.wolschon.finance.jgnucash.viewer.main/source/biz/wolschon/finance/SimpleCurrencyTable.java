 ...
 * Automatically created logger for debug and error-output.
 */
private static final Log LOGGER = LogFactory.getLog(SimpleCurrencyTable.class);
...
public SimpleCurrencyTable() {
  ...
  * to a factor {@link biz.wolschon.numbers.FixedPointNumber}
  ...
  * @return a factor {@link biz.wolschon.numbers.FixedPointNumber}
  *         that is to be multiplied with an ammount of that currency
  *         to get the value in the base-currency.
  */
  ...
  *
  * @param iso4217CurrencyCode a currency-name in capital letters(e.g. "GBP")
  * @param factor a factor {@link biz.wolschon.numbers.FixedPointNumber}
  *         that is to be multiplied with an ammount of that currency
  *         to get the value in the base-currency.
  */
